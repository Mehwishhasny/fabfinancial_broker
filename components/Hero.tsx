...
export default function BlueprintHero() {
  ...
  return () => window.removeEventListener("resize", handleResize);
    ...
    return (
        <>
            <section className="min-h-screen bg-[#f8fbfb] flex flex-col lg:flex-row items-center justify-center px-0 md:px-6 lg:px-20 overflow-hidden relative">
                ...
                <div className="w-full md:w-1/2 text-black ml-0 md:ml-25 lg:ml-25 text-center lg:text-left flex flex-col items-center lg:items-start pt-20 lg:pt-0 mt-0 md:mt-10">
                    ...
                    <p className="mt-6 text-base sm:text-lg lg:text-xl text-gray-800 max-w-md mx-auto lg:mx-0">
                        Smart mortgage solutions designed around your future.
                    </p>

                    <button
                        ref={buttonRef}
                        className="mt-8 px-6 py-3 rounded-full bg-[#0e847b] text-white font-medium border-2 border-white hover:bg-gray-200 hover:text-gray-800 transition"
                    >
                ...
                {/* RIGHT */}
                <div className="mt-12 lg:mt-0 w-full lg:w-1/2 flex justify-center items-center relative">
                    <svg
                        ref={houseRef}
                        width="520"
                        height="520"
                        viewBox="0 0 500 500"
                        fill="none"
                        className="w-[260px] sm:w-[320px] md:w-[380px] lg:w-full max-w-[520px]"
                    >
                        <defs>
                    ...
                    {/* Mortgage Graph */}
                    <div className="hidden md:block absolute top-4 right-20 opacity-20 pointer-events-none">
                        <svg
                            width="460"
                            height="550"
                            viewBox="0 0 260 150"
...
<section
    id="about"
    className="relative min-h-screen overflow-hidden bg-white flex items-center px-6 lg:px-16 py-16 lg:py-0"
>
    ...
    <div className="relative z-10 mx-auto flex max-w-7xl flex-col lg:flex-row items-center gap-16 lg:gap-20">

        {/* LEFT IMAGE */}
        <div className="relative w-full lg:w-1/2 ml-0 lg:ml-30 max-w-md lg:max-w-none">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h2 className="mt-6 lg:mt-8 text-3xl lg:text-5xl font-bold leading-tight text-gray-900">
                Trusted Financial Advisors in UAE
            </h2>

            <p className="mt-6 lg:mt-8 text-base lg:text-lg leading-8 lg:leading-9 text-gray-600">
            ...
            <p className="mt-5 lg:mt-6 text-base lg:text-lg leading-8 lg:leading-9 text-gray-600">
...
<section
    id="advisor"
    className="relative overflow-hidden bg-[#f8fbfb] m-2 py-12 lg:py-20"
>
    {/* Background */}
    ...
    <div className="relative mx-auto max-w-5xl px-5 lg:px-8">
        ...
        {/* Timeline */}
        <div className="relative w-full lg:w-[90%] lg:ml-30 mt-14 lg:mt-20">
            ...
            {[
                ...
                <div
                    key={item.title}
                    className="relative mb-14 lg:mb-20 flex items-center lg:min-h-[260px]"
                >
            ...
            <section
    id="services"
    className="relative overflow-hidden bg-white py-14 lg:py-18 flex flex-col"
>
    {/* Background Blur */}
    ...
    <div className="relative mx-auto max-w-5xl px-5 md:px-8">
        ...
        {/* Cards */}
        <div className="mt-12 md:mt-20 grid gap-6 ml-0 md:ml-10 grid-cols-1 md:grid-cols-2 items-center w-full lg:w-[900px]">
            ...
            <div className="relative overflow-hidden rounded-3xl p-[2px] beam-card">
                ...
                <div className="relative z-10 rounded-[22px] bg-white p-6 md:p-8 transition duration-500 group hover:-translate-y-3">

                    <div className="mb-5 flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-2xl bg-[#0e847b]/10 text-2xl md:text-3xl">
                        🏠
                    </div>
                    ...
                    <p className="mt-4 text-sm md:text-base leading-7 md:leading-8 text-gray-600">
                        Competitive mortgage solutions from leading UAE banks with
                        expert guidance through every step.
                    </p>

                    <button className="mt-6 md:mt-8 font-semibold text-[#0e847b] text-sm md:text-base">
                        Learn More →
                    </button>
          ...
          {/* Mortgage Calculator */}
<section className="ml-0 lg:ml-20 my-14 lg:my-20 px-5 lg:px-6">
    <div
        className="
            relative
            overflow-hidden
...
{/* Insights */}
<section className="bg-gray-50 py-14 md:py-20 px-5 md:px-6">
